...
class MidtransCoreApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        Config::$appendNotifUrl = "http://localhost";
        Config::$overrideNotifUrl = "http://localhost";
        ...
        $this->assertTrue(in_array('X-Append-Notification: http://localhost', $fields["HTTPHEADER"]));
        $this->assertTrue(in_array('X-Override-Notification: http://localhost', $fields["HTTPHEADER"]));
