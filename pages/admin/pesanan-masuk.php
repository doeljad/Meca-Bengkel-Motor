                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) : ?>
                                    <tr class="align-middle">
                                        ...
                                        ?>
                                            <td>
                                                <!-- Tombol View untuk menampilkan modal -->
                                                <button class="btn btn-sm btn-primary" onclick="viewProduk('<?= htmlspecialchars($row['id_pesanan']) ?>')">
                                                    <i class="bi bi-eye"></i>
                                                </button>


                                                <!-- Tombol Edit dan Delete tetap ada -->
                                                <button class="btn btn-sm btn-warning" onclick='updateStatus(<?= json_encode($row) ?>)'>
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button class="btn btn-sm btn-danger" onclick="deletePesanan('<?= $row['id_pesanan'] ?>')">
